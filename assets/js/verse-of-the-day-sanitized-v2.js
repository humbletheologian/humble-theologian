(function () {
  ...
  function cleanVerseText(text) {
    ...
    return text
      // Remove Strong's, lemma and other pipe attributes without consuming
      // the normal space that follows the marked word.
      .replace(
      ...
      .replace(/\s+([,.;:!?])/g, "$1")
      // Normalise repeated whitespace, while preserving word boundaries.
      .replace(/\s+/g, " ")
      .trim();
  }
