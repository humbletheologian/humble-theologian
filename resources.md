...
layout: page
title: "Resources"
description: "Reading lists, devotional material, recommended channels and practical tools for thoughtful Christians."
kicker: "Resource hub"
---
...
- [Glossary]({{ '/glossary/' | relative_url }}) - plain-language definitions of theological, biblical and church terms.
- [RSS Feed]({{ '/feed.xml' | relative_url }}) - subscribe to new articles.

## Organisations I support

I sponsor a child in the Philippines through [Compassion Australia](https://www.compassion.com.au/). I include this here because Christian discipleship is not only about learning ideas. It is also about love becoming practical, especially toward those who are vulnerable, unseen or disadvantaged.
